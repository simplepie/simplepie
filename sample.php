...
if (get_feed_title($rss)) {
	echo "Reading: " . get_feed_title($rss);
}
else echo "Skyzyx.com - Feed Reader";
?>
</title>
...
?>
	<?php if (get_item_permalink($x, $rss) || get_item_title($rss)) { ?><h2><a href="<?php echo get_item_permalink($x, $rss); ?>"><?php echo get_item_title($x, $rss); ?></a></h2><?php } ?>
...
<form action="index.php" name="rssfeed" id="rssfeed">
<h1>Enter URL of an RSS/Atom Feed:</h1>
<input type="text" name="feed" id="feed" value="http://localhost/feedreader/skyzyx.xml" style="width:300px;" />
