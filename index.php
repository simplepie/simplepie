...
@ $rss = simplepie($_GET["feed"], $_GET["xmldump"]);
?>
...
if (get_feed_title($rss)) {
	echo "SimplePie " . sp_version() . " Reading: " . get_feed_title($rss);
}
else echo "SimplePie " . sp_version();
?>
</title>
...
<b>SimplePie Version:</b>
<br /><code><?php echo sp_useragent(); ?></code>
<br />
<br /><b>Read another feed:</b>
<input type="text" name="feed" id="feed" value="" style="width:300px;" />
<input type="submit" value="read me" /><br />
<b style="visibility:hidden;">Read another feed:</b><input type="checkbox" name="xmldump" value="true" /> Enable XMLDump Mode? (Must use feed's full URL)<br />
</form>
<hr />
...
print('<a href="http://www.skyzyx.net/forums/viewforum.php?f=7">Report A Bug</a> | <a href="http://www.skyzyx.net/forums/viewforum.php?f=8">Feature Request</a> | <a href="http://www.skyzyx.net/forums/viewforum.php?f=1">Questions/Comments</a>');
}
else { ?>
...
<input type="text" name="feed" id="feed" value="" style="width:300px;" />
<input type="submit" value="read me" /><br />
<input type="checkbox" name="xmldump" value="true" /> Enable XMLDump Mode? (Must use feed's full URL)
</form>
<br />
<br />
Powered by <?php echo sp_linkback(); ?>.  
<?php
$mtime = explode(' ', microtime());
$totaltime = $mtime[0] + $mtime[1] - $starttime;
printf('Page loaded in %.3f seconds.', $totaltime);
?><br />
<br />
<a href="http://www.skyzyx.net/forums/viewforum.php?f=7">Report A Bug</a> | <a href="http://www.skyzyx.net/forums/viewforum.php?f=8">Feature Request</a> | <a href="http://www.skyzyx.net/forums/viewforum.php?f=1">Questions/Comments</a><br />
<br />
<code><?php echo sp_useragent(); ?></code>
<?php } ?>
