...
<div id="site">
	...
	<div id="content">
		...
		<div>
			...
			<p class="footnote">Powered by <?php echo $feed->name . ' ' . $feed->version . ', Build ' . $feed->build; ?>.  Run the <a href="sp_compatibility_test.php">SimplePie Compatibility Test</a>.</p>
